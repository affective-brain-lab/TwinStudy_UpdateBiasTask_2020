...
.collectFitStatistics <- function(refSummary, refName, compare) {
  if (missing(compare)) {
    ...
    nestedStats <- as.matrix(cbind(
      ...
      compareSummary$Minus2LogLikelihood - refSummary$Minus2LogLikelihood,
      compareSummary$degreesOfFreedom - refSummary$degreesOfFreedom, 
      pchisq(compareSummary$Minus2LogLikelihood - refSummary$Minus2LogLikelihood,
             compareSummary$degreesOfFreedom - refSummary$degreesOfFreedom,lower.tail=F)))
